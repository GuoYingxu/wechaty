 ...
 *    Electron 
 *
 * read more about this in puppet-Electron-bridge.ts
 */
...
(function() {
  ...
  function hookEvents() {
    ...
    rootScope.$on('root:pageInit:success'),
      function(event, data) {
   ...
   * PuppetElectronBridge need this to decide if injection is successful.
   */
  var retObj = {
  ...
  var WechatyBro = {
    ...
    emit, //: window.emit, // send event to Node.js //use electron renderer instead
